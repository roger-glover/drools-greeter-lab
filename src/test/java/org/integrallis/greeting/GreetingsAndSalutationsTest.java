...
//		assertEquals("There should be only one greeting and salutation", 1, results.size());
	...
	public static List<Object[]> fooBar() {
		return Arrays.asList(new Object[][] {
			{ new Person("Dexter Markov", MALE, 8, SINGLE, PHD), new TimeOfDay(9, 0), "Good Morning, Dr. Dexter Markov" },
			{ new Person("Stephen Falken", MALE, 48, SINGLE, PHD), new TimeOfDay(9, 0), "Good Morning, Dr. Stephen Falken" },
